...
cfg.background = {{
    source = { File = wezterm.home_dir .. "/Downloads/pic2.jpg" },
    hsb    = { brightness = 0.30, hue = 1.0, saturation = 0.9 },
    opacity = 1.0,
}}
...
cfg.window_padding             = { left = 14, right = 14, top = 12, bottom = 8 }
...
cfg.max_fps        = 60
cfg.enable_wayland = false   -- force XWayland; avoids compositor crashes on 26.04
cfg.front_end      = "WebGpu" -- replaces broken "Software" renderer
...
cfg.visual_bell  = { fade_in_duration_ms = 60, fade_out_duration_ms = 60, target = "CursorColor" }
...
cfg.key_tables     = { copy_mode = copy_mode_keys }
